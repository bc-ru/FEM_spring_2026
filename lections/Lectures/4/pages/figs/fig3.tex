...
\center
 \begin{tikzpicture}[scale=0.75]
   ...
   \draw[color=blue,line width=1pt] (0,-2) -- (12,0);
   \draw[color=blue,line width=1pt] (0,2) -- (12,0);
   \draw[color=blue,line width=1pt] (0,-2) -- (0,2);

   \draw[color=red,line width=1pt] (1.694,0) circle (1.694);
   
   \draw[color=black, <->] (0,-2.25) -- (12,-2.25);
   \draw(6,-2) node {$h$}; 
   
   \draw[color=black, <->] (1.694,0) -- (2*1.694,0);
   \draw(1.5*1.694,0.2) node {$r$}; 
