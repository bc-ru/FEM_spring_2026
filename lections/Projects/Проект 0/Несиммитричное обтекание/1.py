...
plt.figure(1, figsize=(12, 6)) # задаем размеры графика
...
# Значения решения в узлах сетки
u_values = u2.compute_vertex_values(mesh)

plt.figure(2, figsize=(12, 6)) # задаем размеры графика
...
plt.figure(3, figsize=(12, 6)) # задаем размеры графика
