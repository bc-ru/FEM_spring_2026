...
if menu == "Задачи исследования":
    ...
    + Численное решение задач вихре-потенциального симметричного обтекания пластины в канале: аппроксимация полиномами степени $p=1,2,3$   
    + Численное решение задач вихре-потенциального обтекания при различных значениях циркуляции: три значения $\Gamma$       
    + Численное решение задач вихре-потенциального обтекания при различных высотах пластины: три значения $h$
