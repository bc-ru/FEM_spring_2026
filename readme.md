...
# 7. Работа с программой лабораторной работы #2

Ниже приведены основные команды для полного цикла вычислений.

## 7.1. Полный запуск расчётов
...
запускает серию расчётов: построение сеток, решение задачи и сохранение результатов.

## 7.2. Построение таблицы сходимости

```bash
python3 solver/build_convergence_table.py
```

Эта команда обрабатывает результаты расчётов и формирует таблицу сходимости.

## 7.3. Один отдельный запуск

Для запуска одного расчётного случая используется:
